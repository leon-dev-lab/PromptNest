...
mkdir "%~dp0frontend\dist" >nul 2>nul
> "%~dp0frontend\dist\index.html" echo ^<!doctype html^>^<html^>^<body^>build placeholder^</body^>^</html^>
if exist "%~dp0build\bin" rmdir /s /q "%~dp0build\bin" >nul 2>nul
